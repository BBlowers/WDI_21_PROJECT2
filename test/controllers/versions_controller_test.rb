...
class VersionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post versions_url, params: { version: { content: @version.content, is_current: @version.is_current, project_id: @version.project_id, title: @version.title } }
    end
  ...
  test "should update version" do
    patch version_url(@version), params: { version: { content: @version.content, is_current: @version.is_current, project_id: @version.project_id, title: @version.title } }
